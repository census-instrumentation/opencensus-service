...
// NewExporterWrapper returns a processor.TraceProcessor that converts OpenCensus Proto TraceData
...
func NewExporterWrapper(exporterName string, ocExporter trace.Exporter) processor.TraceProcessor {
...
var _ processor.TraceProcessor = (*ocExporterWrapper)(nil)
