...
import (
	...
	octraceinterceptor "github.com/census-instrumentation/opencensus-service/interceptor/opencensustrace"
...
func Example_endToEnd() {
	...
	tin, err := octraceinterceptor.NewTraceInterceptorOnDefaultPort()
	if err != nil {
