...
type Configuration struct {
	CollectorThriftPort int `yaml:"tchannel-port"`
	CollectorHTTPPort   int `yaml:"collector-http-port"`

	AgentPort              int `yaml:"agent-port"`
	AgentCompactThriftPort int `yaml:"agent-compact-thrift-port"`
	AgentBinaryThriftPort  int `yaml:"agent-binary-thrift-port"`
}
