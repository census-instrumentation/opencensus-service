...
import (
	...
	"github.com/census-instrumentation/opencensus-service/udsreceiver"
	"github.com/census-instrumentation/opencensus-service/udsreceiver/processor/local"
)
...
func main() {
	var (
		...
		flagServiceName      = fs.String("uds.servicename", os.Getenv("HOSTNAME"), "Name of our UDS service")
