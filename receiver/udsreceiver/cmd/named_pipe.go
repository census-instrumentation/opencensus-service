...
import (
	...
	"github.com/census-instrumentation/opencensus-service/udsreceiver/transport/namedpipe"
)
...
func svcTransport(g *run.Group, hnd daemon.Handler, namedPipePath string) {
