...
var _ processor.TraceProcessor = (*spanAppender)(nil)
...
func ocReceiverOnGRPCServer(t *testing.T, sr processor.TraceProcessor, opts ...Option) (oci *Receiver, port int, done func()) {
